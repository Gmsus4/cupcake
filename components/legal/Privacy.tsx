      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 py-16">
        <div className="flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="relative mb-4 p-10 rounded-3xl bg-pink overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col gap-4">
                ...
                <h1 className="font-caveat text-6xl sm:text-7xl text-yellow leading-none">Aviso de Privacidad</h1>
          ...
          <aside className="hidden lg:flex flex-col gap-4 w-72 shrink-0 sticky top-24 self-start">
            ...
            {/* Derechos ARCO */}
            <div className="rounded-2xl bg-pink overflow-hidden p-5 flex flex-col gap-4 border-1 border-pink/10">
              <div className="flex items-center gap-2">
                <IconShieldCheck size={18} className="text-yellow" />
                <p className="text-xs tracking-widest uppercase text-yellow/80 font-semibold">Tus derechos</p>
              </div>
              <div className="grid grid-cols-2 gap-2">
                {["Acceso", "Rectificación", "Cancelación", "Oposición"].map((right) => (
                  <div key={right} className="rounded-xl bg-yellow px-3 py-2.5 text-center">
                    <p className="font-caveat text-pink text-lg leading-none">{right}</p>
                  </div>
                ))}
              </div>
              <p className="text-yellow/70 text-[11px] leading-relaxed">Puedes ejercer tus derechos ARCO en cualquier momento contactándonos directamente.</p>
            </div>
            ...
            <div className="rounded-2xl border-1 border-pink/10 bg-yellow p-5 flex flex-col gap-3">
              ...
              <Link href="/terms" className="w-full text-center rounded-xl border-2 border-pink text-pink font-caveat text-lg py-2.5 hover:bg-pink/10 transition-colors">
